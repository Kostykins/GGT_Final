...
#import "CorePlotHeaders/CPTPlotRange.h"
...
-(NSUInteger)numberOfRecordsForPlot:(CPTPlot *)plot {
    NSUInteger i = [plots indexOfObject:plot];
...
-(NSNumber *)numberForPlot:(CPTPlot *)plot field:(NSUInteger)fieldEnum recordIndex:(NSUInteger)index {
    ...
    if(i == NSNotFound) {
        NSUInteger i = [plotsOfEndDates indexOfObject:plot];
    ...
    if(fieldEnum == CPTScatterPlotFieldY) {
      ...
      return [NSNumber numberWithLong:[entry runningTotalToDate]];
    }
    else {
...
-(void)scatterPlot:(CPTScatterPlot *)plot plotSymbolWasSelectedAtRecordIndex: (NSUInteger)index {
    if(!plot.hidden){
        ...
        NSString *amount = [formatter stringFromNumber:[NSNumber numberWithLong:[entry amount]]];
...
- (IBAction)buttonPress:(id)sender {
    ...
    NSUInteger index = [buttonReferences indexOfObject:button];
